<template>
    <header :class="{'open':isSubmenuOpen}">
        <div class="gnb">
            ...
            <nav @mouseenter="isSubmenuOpen = true;" @mouseleave="isSubmenuOpen = false;">
                <ul>
                    <li class="menu-item">
                        <span>캘린더</span>
                        <div class="submenu">
                            <ul>
                                <li><router-link :to="{name: 'calendar'}">전체 채용</router-link></li>
                                <li><router-link :to="{name: 'myCalendar'}">마이 캘린더</router-link></li>
                            </ul>
                        </div>
                    </li>
                    <li class="menu-item">
                        ...
                        <div class="submenu">
                            <ul>
                                <li><router-link :to="{name: 'resume'}">자기소개서</router-link></li>
                                <li><router-link :to="{name: 'myNote'}">마이 노트</router-link></li>
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <div class="lnb" @mouseenter="isSubmenuOpen = true;" @mouseleave="isSubmenuOpen = false;"></div>
    </header>
</template>
...
const handleToolBoxClick = (e) => {
    if (toolBox.value && !toolBox.value.contains(e.target) && isToolboxOpen.value) {
